...
namespace Jarvis.Project.Services.VoskSpeechRecognition
{
    public class VoskSpeechRecognition : IDisposable
    {
            ...
            if (!string.IsNullOrEmpty(result))
            {
                ...
                if (currentMode == RecognitionMode.JarvisListening && !isListeningForCommand)
                {
                    if (text.Contains("джарвис"))
                    {
                        ...
                        ProjectJarvis.Settings.VoiceAssistant.VoiceJarvisClass.JarvisVoiceComplete();
                        return;
                    }
                }
        ...
        private void OpenProgram(string service)
        {
            ...
            var exePaths = ProjectJarvis.Settings.PathManager.ExePathManagerClass.LoadPathsFromJson();
            ...
            ProjectJarvis.Settings.VoiceAssistant.VoiceJarvisClass.JarvisVoiceYes();
        }
